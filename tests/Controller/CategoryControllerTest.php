...
final class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[isActive]' => 'Testing',
            'category[position]' => 'Testing',
            'category[relation]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'category[icon]' => 'Something New',
            'category[isActive]' => 'Something New',
            'category[position]' => 'Something New',
            'category[relation]' => 'Something New',
        ]);
