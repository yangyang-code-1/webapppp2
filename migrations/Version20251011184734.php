 ...
 */
final class Version20251011184734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commission CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commission CHANGE updated_at updated_at DATETIME NOT NULL');
    }
}
